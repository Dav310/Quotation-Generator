...
export default function EditableFieldsSidebar() {
  ...
  const fields: { key: keyof QuotationMeta; label: string }[] = [
    ...
    { key: "clientDesignation", label: "Client Designation" },
    ...
    { key: "providers1", label: "Providers1" },
    { key: "providers2", label: "Providers2" },
  ...
  return (
    <Paper
      elevation={0}
      className="quo-sidebar-card p-6 flex flex-col gap-5 print:hidden"
    >
